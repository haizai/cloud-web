  ...
  <div id="register">
    ...
    <div class="login-body">
      ...
      <div class="login-line">
        ...
        <div class="login-line-tip" v-show="passwordStrength > 0 ">
          密码强度：
      ...
      <div class="login-line">
        <div class="login-btn login-submit" @click="register()">注册</div>
        <router-link :to="{name: 'login'}"><div class="login-btn login-reg">已有账号</div></router-link>
      </div>
    </div>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      register() {
        this.$http.post(this.urlPrefix + 'register',{account:this.account,password:this.password}).then(res=>{
